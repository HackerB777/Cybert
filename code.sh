...
echo -e ${GREEN}""
echo -e ${YELLOW}"   [+] Advanced Payload Generator"
echo -e ${YELLOW}"   [+] Multi-OS Tool Builder"
echo -e ${YELLOW}"   [+] Terminal Command Interface"
echo -e ${GREEN}""
echo -e ${RED}"   Coded By : MR DART"
echo -e ${RED}"   GitHub   : github.com/HackerB777"
echo -e ${RED}"############################################################"
}
...
menu
#Coded By MR Dart....Copying this code doesn't make it 
